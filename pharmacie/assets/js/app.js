  ...
  poteau.eachLayer(function (layer) {
    if (map.hasLayer(poteauLayer)) {
      if (map.getBounds().contains(layer.getLatLng())) {
        $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/medical.png"></td><td class="feature-name">' + layer.feature.properties.NAME + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');
      }
    }
  });
...
$.getJSON("data/pharma.geojson", function (data) {
  poteau.addData(data);
...
var groupedOverlays = {
  "  Points d’intérêt ": {
    "<img src='assets/img/medical.png' width='24' height='28'>&nbsp;Pharmacie": poteauLayer
...
$(document).one("ajaxStop", function () {
  ...
  $("#searchbox").typeahead({
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='medical.png' width='35' height='30'>&nbsp;PHARMACIE</h4>",
