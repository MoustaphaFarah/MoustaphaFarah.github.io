...
var poteau = L.geoJson(null, {
  pointToLayer: function (feature, latlng) {
    return L.marker(latlng, {
      icon: L.icon({
        iconUrl: "assets/img/accident.png",
        iconSize: [24, 28],
        iconAnchor: [12, 28],
        popupAnchor: [0, -25]
      }),
...
$.getJSON("data/accident.geojson", function (data) {
  poteau.addData(data);
...
var groupedOverlays = {
  "  Points d’intérêt ": {
    "<img src='assets/img/accident.png' width='24' height='28'>&nbsp;Accident": poteauLayer,
    "<img src='assets/img/crime.png' width='24' height='28'>&nbsp;Crime": compteurLayer
  },
  "Reference": {
    "Commune": boroughs,
    "Route": subwayLines
...
$(document).one("ajaxStop", function () {
  ...
  $("#searchbox").typeahead({
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='images.png' width='35' height='30'>&nbsp;Accident</h4>",
