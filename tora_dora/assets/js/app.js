...
$.getJSON("data/zonage.geojson", function (data) {
...
var subwayLines = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Habitation </th><td>" + feature.properties.HABITATION + "</td></tr>"  + "<tr><th>Zone </th><td>" + feature.properties.Zone + "</td></tr>"+ "<table>";
      layer.on({
        click: function (e) {
...
$.getJSON("data/enquete_pk12.geojson", function (data) {
  zone4.addData(data);
});
