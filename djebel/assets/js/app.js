...
var subwayLines = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Id</th><td>" + feature.properties.Id + "<tr><th>Habitation</th><td>" + feature.properties.Habitation  + "<tr><th>Perimetre</th><td>" + feature.properties.Perimetre + "<tr><th>Area</th><td>" + feature.properties.Area  +"<table>";
      layer.on({
        click: function (e) {
...
$.getJSON("data/logementss.geojson", function (data) {
...
var hayabley_zone2 = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>ID</th><td>" + feature.properties.Id + "<tr><th>Habitations</th><td>" + feature.properties.Habitation  + "<table>";
      layer.on({
        click: function (e) {
          $("#feature-title").html(feature.properties.Route);
          $("#feature-info").html(content);
...
$.getJSON("data/logement_ilot.geojson", function (data) {
...
var poteau = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>ID</th><td>" + feature.properties.Id + "</td></tr>"   +"<table>";
      layer.on({
        click: function (e) {
...
$.getJSON("data/vegetation.geoJson", function (data) {
  poteau.addData(data);
...
attributionControl.onAdd = function (map) {
  ...
  div.innerHTML = "<span class='hidden-xs'> DJIB-CARTO  | </span>";
  return div;
};
...
var zone4BH = new Bloodhound({
  ...
  $("#searchbox").typeahead({
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='logo.jpg' width='35' height='30'>&nbsp;Vegetation</h4>",
