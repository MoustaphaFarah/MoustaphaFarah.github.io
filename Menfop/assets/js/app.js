...
var zone4 = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
       var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>NOM</th><td>" + feature.properties.nom + "</td></tr>" + "<tr><th>Etablissement</th><td>" + feature.properties.ETS + "</td></tr>" + "<tr><th>COMMUNE</th><td>" + feature.properties.Commune + "</td></tr>" + "<tr><th>District</th><td>" + feature.properties.District + "</td></tr>" + "</td></tr>" + "<tr><th>Nom du directeur</th><td>" + feature.properties.Directeur + "</td></tr>" + "</td></tr>" +  '<img src="'+ feature.properties.photo +'" style="width:300px;height:300px;">'    +"<table>";
      layer.on({
        click: function (e) {
...
$.getJSON("data/menfop.geojson", function (data) {
  zone4.addData(data);
});
...
var groupedOverlays = {
  "  Points d’intérêt ": {
    "<img src='assets/img/map1.png' width='24' height='28'>&nbsp;Ecole": zone4Layer
...
var zone4BH = new Bloodhound({
  ...
  $("#searchbox").typeahead({
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/img/map1.png' width='35' height='30'>&nbsp; MENFOP</h4>",
      suggestion: Handlebars.compile(["{{name}}<br>&nbsp;<small>{{address}}</small>"].join(""))
    }
  },{
    name: "GeoNames",
