...
var subwayLines = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Epoque de Constrution</th><td>" + feature.properties.Epoque_con + "<tr><th>Typologie</th><td>" + feature.properties.Typologie_ + "<tr><th>Intervention</th><td>" + feature.properties.Interventi + "</td></tr>"  +'<img src="'+ feature.properties.data_photo +'" style="width:300px;height:300px;">'+ "<table>";
      layer.on({
        click: function (e) {
...
$.getJSON("data/proje.geojson", function (data) {
