...
var subwayLines = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Id</th><td>" + feature.properties.Id + "<tr><th>Code du batiment</th><td>" + feature.properties.Code_Bati +"<table>";
      layer.on({
        click: function (e) {
...
$.getJSON("data/batiment.geojson", function (data) {
...
var groupedOverlays = {
  ...
  "Reference": {
    "Quartier 7": boroughs,
    "Structure": subwayLines,
    "Logement":hayabley_zone2
