var map, featureList, communeSearch = [], pharmaSearch = [];
  ...
  pharma.eachLayer(function (layer) {
    if (map.hasLayer(pharmaLayer)) {
      if (map.getBounds().contains(layer.getLatLng())) {
        $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/icone.png"></td><td class="feature-name">' + layer.feature.properties.Code + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');
      }
    }
  });
...
/* Empty layer placeholder to add to layer control for listening when to add/remove pharma to markerClusters layer */
var pharmaLayer = L.geoJson(null);
var pharma = L.geoJson(null, {
  pointToLayer: function (feature, latlng) {
    return L.marker(latlng, {
      icon: L.icon({
        iconUrl: "assets/img/icone.png",
        iconSize: [24, 28],
        iconAnchor: [12, 28],
        popupAnchor: [0, -25]
      }),
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Code</th><td>" + feature.properties.Code + "</td></tr>" + "<tr><th>Superficie</th><td>" + feature.properties.Superficie + "</td></tr>"  + "<tr><th>Quartier</th><td>" + feature.properties.Quartier + "</td></tr>" + '<img src="'+ feature.properties.Photo +'" style="width:300px;height:300px;">'  +"<table>";
      layer.on({
        click: function (e) {
          $("#feature-title").html(feature.properties.Code);
      ...
      $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/icone.png"></td><td class="feature-name">' + layer.feature.properties.Code + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');
      pharmaSearch.push({
        name: layer.feature.properties.Code,
...
$.getJSON("data/nid_poule.geojson", function (data) {
  pharma.addData(data);
...
map = L.map("map", {
  ...
  layers: [osmLayer, commune, markerClusters, highlight],
  zoomControl: false,
...
var groupedOverlays = {
  "  Points d’intérêt ": {
    "<img src='assets/img/icone.png' width='24' height='28'>&nbsp;Nid de poule": pharmaLayer
...
$(document).one("ajaxStop", function () {
  ...
  $("#searchbox").typeahead({
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='nid.jpg' width='35' height='30'>&nbsp;Nid de poule</h4>",
