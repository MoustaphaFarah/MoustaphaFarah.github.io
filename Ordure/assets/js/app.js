...
var poteau = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
       var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Quartier</th><td>" + feature.properties.quartiers + "</td></tr>" +    '<img src="'+ feature.properties.photo +'" style="width:300px;height:300px;">'   +"<table>";
      layer.on({
        click: function (e) {
          $("#feature-title").html(feature.properties.quartiers);
          $("#feature-info").html(content);
          $("#featureModal").modal("show");
      ...
      $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="map1.png"></td><td class="feature-name">' + layer.feature.properties.quartiers + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');
      compteurSearch.push({
         name: layer.feature.properties.quartiers,
         source: "compteur",
        id: L.stamp(layer),
...
$.getJSON("data/Bac.geojson", function (data) {
  poteau.addData(data);
...
var compteur = L.geoJson(null, {
  pointToLayer: function (feature, latlng) {
    return L.marker(latlng, {
      ...
      title: feature.properties.quartiers,
      riseOnHover: true
    });
  },
  onEachFeature: function (feature, layer) {
...
$.getJSON("data/depot.geojson", function (data) {
...
var groupedOverlays = {
  "  Points d’intérêt ": {
   "<img src='assets/img/marker.png' width='24' height='28'>&nbsp;Bac poubelle": poteauLayer,
   "<img src='assets/img/map1.png' width='24' height='28'>&nbsp;Depot des ordures": compteurLayer
...
var zone4BH = new Bloodhound({
  ...
  $("#searchbox").typeahead({
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='marker.png' width='35' height='30'>&nbsp;Bac poubelle </h4>",
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='map1.png' width='35' height='30'>&nbsp; Depot des ménages</h4>",
      suggestion: Handlebars.compile(["{{name}}<br>&nbsp;<small>{{address}}</small>"].join(""))
    }
  },{
    name: "zone",
