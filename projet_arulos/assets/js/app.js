...
var poteau = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Numero</th><td>" + feature.properties.NAME + "</td></tr>" + "<tr><th>Nom</th><td>" + feature.properties.nom + "</td></tr>" + "<tr><th>Nombre</th><td>" + feature.properties.nb_menage + "</td></tr>" + "<tr><th>Type</th><td>" + feature.properties.type + "</td></tr>" + "</td></tr>" + "<tr><th>Ocuupation</th><td>" + feature.properties.occupation + "</td></tr>"+  "</td></tr>" + "<tr><th>Adresse</th><td>" + feature.properties.adresse + "</td></tr>"+   "</td></tr>" + "<tr><th>Commune</th><td>" + feature.properties.commune+ "</td></tr>"+  '<img src="'+ feature.properties.photo +'" style="width:300px;height:300px;">'  +"<table>";
      layer.on({
        click: function (e) {
      ...
      $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/accident.png"></td><td class="feature-name">' + layer.feature.properties.NAME + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');
      poteauSearch.push({
...
var groupedOverlays = {
  "  Points d’intérêt ": {
    "<img src='assets/img/house.png' width='24' height='28'>&nbsp;Ménage": poteauLayer
...
$(document).one("ajaxStop", function () {
  ...
  $("#searchbox").typeahead({
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='house.png' width='35' height='30'>&nbsp;Ménage</h4>",
